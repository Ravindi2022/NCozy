...
<section class="bg-white mt-16">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-12">
        <div class="flex flex-col mb-8 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <img src="https://drive.google.com/file/d/1Nwpvd_IexWNX1CbBiQ50nFegZcVGubhQ/view?usp=sharing" class="h-40" alt="NCozy Logo" />
        </div>
        <a href="home.php" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full hover:bg-gray-200 " role="alert">
        ...
        <h1 class="mb-12 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">Welcome to NCozy Admin Dashboard.</h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">Your one-stop platform for NSBM undergraduate accommodation management. Simplify daily tasks, streamline communication, and gain valuable insights.</p>
